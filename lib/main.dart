  ...
  if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyDuC5_LdEFlvlRRLNPARrT84jYtQAZeuIQ',
        appId: '1:849886238487:android:69efa5af0ae52a9bbc0952',
        messagingSenderId: '849886238487',
        projectId: 'yallato-ee4b1',
      ),
    );
  } else {
    await Firebase.initializeApp();
