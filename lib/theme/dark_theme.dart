...
ThemeData dark = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFFd73a22),
  ...
  textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: const Color(0xFFd73a22))),
  colorScheme: const ColorScheme.dark(
          primary: Color(0xFFd73a22), secondary: Color(0xFFd73a22))
